...
new_image = ImageTk.PhotoImage(Image.open('C:/Users/Himangshu De/Documents/Media and Others/Git Folder/Tkinter Projects/new.png'))
new_button = tkinter.Button(menu_frame, image=new_image, command=new_note)
new_button.grid(row=0, column=0, padx=5, pady=5)

open_image = ImageTk.PhotoImage(Image.open('C:/Users/Himangshu De/Documents/Media and Others/Git Folder/Tkinter Projects/open.png'))
open_button = tkinter.Button(menu_frame, image=open_image, command=open_note)
open_button.grid(row=0, column=1, padx=5, pady=5)

save_image = ImageTk.PhotoImage(Image.open('C:/Users/Himangshu De/Documents/Media and Others/Git Folder/Tkinter Projects/save.png'))
save_button = tkinter.Button(menu_frame, image=save_image, command=save_note)
save_button.grid(row=0, column=2, padx=5, pady=5)

close_image = ImageTk.PhotoImage(Image.open('C:/Users/Himangshu De/Documents/Media and Others/Git Folder/Tkinter Projects/close.png'))
